...
namespace MarioLandMod.TransformationFiles
{
    public class TransformationItem_Mario : ModItem
    {
        ...
        public override void UpdateAccessory(Player player, bool hideVisual)
        {
            ...
            player.AddBuff(ModContent.BuffType<TransformationBuff_Mario>(), 2);
        }
        ...
        public override void ModifyTooltips(List<TooltipLine> tooltips)
        {
            ...
            tooltips.Add(new TooltipLine(Mod, "Transformation", "Transforms the player into Mario"));
        }
    ...
    public class TransformationBuff_Mario : ModBuff
    {
        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("Mario Time!");
            Description.SetDefault($"You have the powers of Mario");
